        ...
        <div class="row justify-content-center">
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_alumni.php">View Alumni</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_events.php">View News/Events</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Access exclusive job listings, workshops, and seminars to nurture your professional growth</p>
                    </div>
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_advertisements.php">View Advertisements</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="<?php echo 'update_profile.php?email='.htmlspecialchars($_SESSION['logged_account']['email'])?>">View Profile</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="income-fund.jpg" class="card-img-top" alt="View Section">
                    <div class="card-body">
                        <h5 class="card-title">View</h5>
                        <p class="card-text">Explore detailed insights, updates, and resources available to alumni members.</p>
                    </div>
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_page.php">View Section</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="funds.png" class="card-img-top" alt="View Section">
                    <div class="card-body">
                        <h5 class="card-title">Manage Funds</h5>
                        <p class="card-text">Monitor, manage, and allocate alumni donations and financial resources efficiently</p>
                    </div>
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="manage_funds.php">Manage Funds</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_page1.php">Manage Funds</a> 
                    </div>
                </div>
            </div>
